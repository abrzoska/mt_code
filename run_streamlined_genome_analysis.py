...
count_indels.run_parrallel_analysis(cis_reg_indel_folder, indel_file, 1)
genes_to_cis_reg = count_indels.determine_cis_regs_genes(gene_input_file)
count_indels.summarize_cis_regs(genes_to_cis_reg, cis_reg_indel_folder).to_csv(gene_result_csv)
